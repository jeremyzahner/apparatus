...
###
	...
	then
		...
		ssh $dev_ssh_user@$dev_ssh_host "mysql --defaults-extra-file=/home/$dev_ssh_user/apparatus/apparatus.my.cnf -h $dev_db_host $dev_db_name < $dev_assets_path/dbsync.sql"
		echo $'\n''DB fully synced!'$'\n'
		##
	fi
...
###
	...
	then
		...
		ssh $stage_ssh_user@$stage_ssh_host "mysql --defaults-extra-file=/home/$dev_ssh_user/apparatus/apparatus.my.cnf -h $stage_db_host $stage_db_name < $stage_assets_path/dbsync.sql"
		echo $'\n''DB fully synced!'$'\n'
		##
	fi
...
###
	...
	then
		...
		ssh $live_ssh_user@$live_ssh_host "mysql --defaults-extra-file=/home/$dev_ssh_user/apparatus/apparatus.my.cnf -h $live_db_host $live_db_name < $live_assets_path/dbsync.sql"
		echo $'\n''DB fully synced!'$'\n'
		##
	fi
