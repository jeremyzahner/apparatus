...
###
	...
	then
		...
		rsync -e ssh -rvzPc --update --stats $dev_ssh_user@$dev_ssh_host:$dev_assets_path/*  $local_assets_path/ && \
		echo $'\n''All Assets pushed!'$'\n'
		##
	fi
	...
	then
		...
		rsync -e ssh -rvzPc --update --stats $dev_ssh_user@$dev_ssh_host:$dev_assets_path/dbsync.sql $local_assets_path/dbsync.sql && \

		mysql --defaults-extra-file=~/apparatus/apparatus.my.cnf -h $local_db_host $local_db_name < $local_assets_path/dbsync.sql && \
...
###
	...
	then
		...
		rsync -e ssh -rvzPc --update --stats $stage_ssh_user@$stage_ssh_host:$stage_assets_path/* $local_assets_path/ && \
		echo $'\n''All Assets pushed!'$'\n'
		##
	fi
	...
	then
		...
		rsync -e ssh -rvzPc --update --stats $stage_ssh_user@$stage_ssh_host:$stage_assets_path/dbsync.sql $local_assets_path/dbsync.sql && \
...
###
	...
	then
		...
		rsync -e ssh -rvzPc --update --stats $live_ssh_user@$live_ssh_host:$live_assets_path/* $local_assets_path/ && \
		echo $'\n''All Assets pushed!'$'\n'
		##
	fi
	...
	then
		...
		rsync -e ssh -rvzPc --update --stats $live_ssh_user@$live_ssh_host:$live_assets_path/dbsync.sql $local_assets_path/dbsync.sql && \
