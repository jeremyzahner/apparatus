...
###
	...
	ssh $dev_ssh_user@$dev_ssh_host "cd $dev_path && composer install"
...
###
	...
	ssh $stage_ssh_user@$stage_ssh_host "cd $stage_path && composer install"
...
###
	...
	ssh $live_ssh_user@$live_ssh_host "cd $live_path && composer install"
